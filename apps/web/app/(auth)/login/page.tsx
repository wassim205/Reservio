...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-amber-50 via-orange-50 to-rose-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="absolute -right-4 -top-4 w-full h-full bg-linear-to-br from-orange-200 to-rose-200 rounded-3xl rotate-2 blur-sm opacity-50" />
        <div className="absolute -right-2 -top-2 w-full h-full bg-linear-to-br from-orange-300 to-rose-300 rounded-3xl rotate-1 opacity-30" />
        ...
        <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border-2 border-orange-200 overflow-hidden">
          <div className="absolute top-0 right-0 w-40 h-40 bg-linear-to-br from-orange-400 to-rose-400 opacity-10 rounded-full blur-2xl" />

          {/* Logo */}
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-orange-500 to-rose-500 rounded-xl blur-lg opacity-50" />
              <div className="relative bg-linear-to-r from-orange-500 to-rose-500 p-2.5 rounded-xl">
